...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <header style="border-color: #ee603c">
...
<form id="eventoadd" method="post" action="cadastar_evento.php" enctype="multipart/form-data">
<div class="row">
            <div class="col-md-6">
                <label>Nome</label><br>
                <input type="text" placeholder="Digite o Nome do Evento" name="eventonome" required><br><br>
            </div>    
                <div class="col-md-6">
...
<div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="date" required id="data" name="data"><br>
                    </div>  
                    <div class="col-md-6">
...
<div class="row">
                    ...
                    <div class="col-md-6">
                        <label>Horário de Encerramento</label><br>
                        <input type="time" required id="tempo2" name="tempo2"><br>
                    </div>
...
<div class="row">
    ...
    <div class="col-md-8"><br>
        ...
        <textarea cols="25" rows="5" name="obs" maxlength="250" style="width: 85%"></textarea>
  
       
    </div>
    <div class="col-md-4"><br>
         <br><br><br><input type="submit" value="Cadastrar" id="botao" style="backgorund-color: #17395e; border-radius: 40px; border-color: #ee603c">
    </div>
</form>
</div>     
